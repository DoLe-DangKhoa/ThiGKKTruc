package com.example.loginservice.jwt.util;
...
public class JwtUtil {
    ...
    private static final String USER = "khoa";
    private static final String SECRET = "hey khoa the secrect length must be at least 256 bits" +
            " please no reveal!";
