...
import com.example.activemq.service.SubjectService;
...
public class RestTemplateController {
    ...
    //ActiveMQ Request
    //Send du lieu len active MQ
    @PostMapping(path = "/activemq/sendSubjectQueue")
    public User sendSubjectQueue(@RequestBody User subject){
        subjectService.sendSubject(subject);
        return subject;
    }
